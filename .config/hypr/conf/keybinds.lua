...
hl.bind(mainMod .. " + D",      hl.dsp.exec_cmd(menu),     { description = "Open application menu" })
...
-- Actions
hl.bind("Print", hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | swappy -f -"), { description = "Screenshot area to swappy" })
